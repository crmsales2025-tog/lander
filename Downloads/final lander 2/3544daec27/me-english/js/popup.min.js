...
$(document).ready(function() {
	$(function(){
		...
		var oldPrice = parseInt($(oldPriceClass + ':first').text()) || 0;			// Старая цена из документа
		var newPrice = parseInt($(newPriceClass + ':first').text()) || 0;			// Новая цена из документа
		...
		if ((geo == 'RU') && ((newPrice == 0) || (newPrice == 147))) {
		...
		var message02 = '<div class="show-message__item show-message_online"><i class="everad-sprite everad-sprite-online_user"></i><p class="show-message__info">The number of visitors right now: <span id="js-user-id3"></span></p></div>';
		/* Сообщение "Заказ обратного звонка"" */
		var message03 = '<div class="show-message__item show-message_online"><i class="everad-sprite everad-sprite-callback"></i><p class="show-message__info"> Hurry Up!, only few bottles left</p></div>';
		/* Сообщение "Осталось Задуманное количество упаковок упаковок"" */
		// var message04 = '<div class="show-message__item show-message_call last-message"><i class="everad-sprite everad-sprite-bucket"></i><p class="show-message__info"><span style="font-size: 16px;">Left <span class="pacedNamed"></span> by stock<br><span style="color: red;font-size: 20px;font-weight: bold;"><span style="color: red;">' 17 '</span></span> bottles.</span></p></div>';
		...
		function showPopupBegin(lp, sp) {
			...
			if ((sp.length == 2) && (flagPhone)) {
				...
				//  	message01 = '<div class = "show-message__item show-message_call"> <i class = "everad-sprite everad-sprite-bucket"> </i> <p class = "show-message__info"> <span class = "js-show -name "> <span class =" js-name "> '+ name +' </span> </span>, placed an order for the amount of <span class =" x_price_current x_price "> '+ summ +' < / span> <span class = "x_currency"> '+ curr +' </span>, ordered <span class = "bay"> '+ step +' </span> <span class = "paced"> packages </ span> <br> <span class = "package_left"> <span class = "pacedNamed"> </span> left by stock <br> <span class = "blink"> '+ lp +' </span> <span class = "blink_me"> '+ endpack +' </span> </span> </p> </div> ';
				//  } else {
				//  	message01 = '<div class="show-message__item show-message_call"><i class="everad-sprite everad-sprite-bucket"></i><p class="show-message__info"><span class="js-show-name"><span class="js-name">' + name + '</span></span>, booked a full course</p></div>';
				// }
