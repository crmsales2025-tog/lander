...
(Base.extend = function (t, i) {
    ...
    Base._prototyping = !0;
    var n = new this();
    e.call(n, t), (n.base = function () {}), delete Base._prototyping;
    var s = n.constructor,
        o = (n.constructor = function () {
            if (!Base._prototyping)
                ...
                else if (null !== arguments[0]) return (arguments[0].extend || e).call(arguments[0], n);
        });
    return (
        (o.ancestor = this),
...
!(function (t) {
    ...
    (function (t) {
        ...
        FlipClock.Face = FlipClock.Base.extend({
            ...
            createDivider: function (i, e, n) {
                ...
                var o = ['<span class="' + this.factory.classes.divider + " " + (e ? e : "").toLowerCase() + '">', '<span class="' + this.factory.classes.label + '">' + (i ? i : "") + "</span>", s, "</span>"],
                    a = t(o.join(""));
            ...
            addDigit: function (t) {
                var i = this.createList(t, { classes: { active: this.factory.classes.active, before: this.factory.classes.before, flip: this.factory.classes.flip } });
        ...
        FlipClock.Factory = FlipClock.Base.extend({
            ...
            constructor: function (i, e, n) {
                n || (n = {}),
                    ...
                    (this.running = !1),
                    this.base(n),
                    (this.$el = t(i).addClass(this.classes.wrapper)),
                    (this.$wrapper = this.$el),
                    (this.original = e instanceof Date ? e : e ? Math.round(e) : 0),
            ...
            loadClockFace: function (t, i) {
                ...
                return (
                    ...
                    (e = FlipClock[t] ? new FlipClock[t](this, i) : new FlipClock[this.defaultClockFace + n](this, i)),
                    e.build(),
                    (this.face = e),
                    s && this.start(),
                    this.face
                ...
                var i = this.getPrevDigit() ? this.getPrevDigit() : this.digit,
                    e = t(
                        [
                            ...
                            this.createListItem(this.classes.before, i),
        ...
        FlipClock.Time = FlipClock.Base.extend({
            ...
            digitize: function (i) {
                ...
                if (
                    ...
                    this.minimumDigits > e.length)
                )
                    for (var n = e.length; n < this.minimumDigits; n++) e.unshift("0");
                return e;
            },
            ...
            getMilitaryTime: function (t, i) {
                "undefined" == typeof i && (i = !0), t || (t = this.getDateObject());
                var e = [t.getHours(), t.getMinutes()];
                return i === !0 && e.push(t.getSeconds()), this.digitize(e);
            },
            ...
            getTime: function (t, i) {
                "undefined" == typeof i && (i = !0), t || (t = this.getDateObject()), console.log(t);
                var e = t.getHours(),
                    n = [e > 12 ? e - 12 : 0 === e ? 12 : e, t.getMinutes()];
                return i === !0 && n.push(t.getSeconds()), this.digitize(n);
            },
    ...
    (function (t) {
        FlipClock.TwentyFourHourClockFace = FlipClock.Face.extend({
            ...
            build: function (i) {
                ...
                var i = i ? i : this.factory.time.getMilitaryTime(!1, this.showSeconds);
                i.length > n.length &&
                    t.each(i, function (t, i) {
                        e.createList(i);
                    }),
                    this.createDivider(),
                    this.createDivider(),
                    t(this.dividers[0]).insertBefore(this.lists[this.lists.length - 2].$el),
                    t(this.dividers[1]).insertBefore(this.lists[this.lists.length - 4].$el),
                    this.base();
            },
            flip: function (t, i) {
                this.autoIncrement(), (t = t ? t : this.factory.time.getMilitaryTime(!1, this.showSeconds)), this.base(t, i);
            },
        });
    })(jQuery),
    (function (t) {
        FlipClock.CounterFace = FlipClock.Face.extend({
            ...
            constructor: function (t, i) {
                "object" != typeof i && (i = {}),
                    (t.autoStart = !!i.autoStart),
                    i.autoStart && (this.shouldAutoIncrement = !0),
        ...
        FlipClock.DailyCounterFace = FlipClock.Face.extend({
            ...
            build: function (i) {
                ...
                (i = i ? i : this.factory.time.getDayCounter(this.showSeconds)),
                    ...
                    this.showSeconds ? t(this.createDivider("Seconds")).insertBefore(this.lists[this.lists.length - 2].$el) : (s = 2),
                    t(this.createDivider("Minutes")).insertBefore(this.lists[this.lists.length - 4 + s].$el),
                    t(this.createDivider("Hours")).insertBefore(this.lists[this.lists.length - 6 + s].$el),
    ...
    (function (t) {
        FlipClock.HourlyCounterFace = FlipClock.Face.extend({
            ...
            build: function (i, e) {
                ...
                (e = e ? e : this.factory.time.getHourCounter()),
                    e.length > s.length &&
        ...
        FlipClock.TwelveHourClockFace = FlipClock.TwentyFourHourClockFace.extend({
            ...
            build: function () {
                ...
                this.base(i),
                    ...
                    (this.meridium = t(['<ul class="flip-clock-meridium">', "<li>", '<a href="#">' + this.meridiumText + "</a>", "</li>", "</ul>"].join(""))),
    ...
    (function (t) {
        (FlipClock.Lang.Russian = {years: "years", months: "months", days: "days", hours: "hours", minutes: "minutes", seconds: "seconds"}),
